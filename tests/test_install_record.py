...
class InstallRecordTests(unittest.TestCase):
    ...
    @patch.object(Application, 'persist_scheduled_logon_task_state', return_value=None)
    ...
    def test_logon_task_install_updates_install_record(
        ...
        mock_persist_scheduled_logon_task_state: Mock,
    ) -> None:
        del mock_persist_scheduled_logon_task_state
        app = Application()
        ...
        app.persist_scheduled_logon_task_state.assert_called_once_with(
            None,
            True,
            create_if_missing=True,
        )

    @patch('wifi_pref_manager.scheduler.persist_scheduled_logon_task_state')
    ...
    def test_scheduler_install_updates_install_record(
        ...
        mock_persist_scheduled_logon_task_state.assert_called_once_with(
            None,
            True,
            create_if_missing=True,
        )
